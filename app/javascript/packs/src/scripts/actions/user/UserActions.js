...
export function updateMe(params) {
  return dispatch => {
    ...
    return API.put('/users/update_me', params)
...
export function getMainInfo() {
  return dispatch => {
    ...
    return API.get('/users/main_info')
...
export function updatePhoneAndNotifications(params) {
  return dispatch => {
    ...
    return API.put('/users/update_phone_and_notifications', { ...params })
...
export function getUserInfoForEdit() {
  return dispatch => {
    ...
    return API.get('/users/info_for_edit')
